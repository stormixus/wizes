...
<table class="table table-striped">
	...
	<tbody>
		...
		<tr>
			<td>썸네일 넓이(px)</td>
			<td>
				<input type="number" name="imgwidth" placeholder="(미입력시 자르지 않음)" size="12" value="<?php echo $elekey['imgwidth']?>" class="form-control input-sm only_num"  />
			</td>
		</tr>
		<tr>
			<td>썸네일 높이(px)</td>
			<td>
				<input type="number" name="imgheight" placeholder="(미입력시 자르지 않음)" size="12" value="<?php echo $elekey['imgheight']?>" class="form-control input-sm only_num"  />
			</td>
		</tr>
	</tbody>
</table>
